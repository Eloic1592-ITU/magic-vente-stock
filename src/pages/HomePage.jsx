...
function HomePage() {
  ...
  return (
    ...
    >
      <button
        onClick={disconnect}
        className="mt-4 bg-[#3c2e1e] text-[#f6c669] absolute font-semibold px-4 py-2 hover:cursor-pointer"
      ...
      <div className="w-full flex justify-center py-10 flex-col items-center">
        <img
          ...
          alt="logoGondorChic"
        />
        <p className="text-3xl font-semibold text-[#CFA15D]">GANDOR</p>
        <div className="grid w-fit">
          <div className="mb-5">
            <h1 className="text-7xl font-semibold text-[#CFA15D]">CHIC</h1>
          </div>
      ...
      <div className="grid grid-cols-12">
        <div className="ml-48 col-span-6">
          ...
          <p className="text-2xl text-black leading-10 mt-10">
            ...
            <span className=" text-[#CFA15D]">{item.itemName}</span> <br></br>au
            prix de{" "}
            <span className=" text-[#CFA15D]">
              {item.itemPrice} gondariary.
            </span>
          </p>
          <div className="flex items-center my-10">
            <p className="text-black text-2xl mr-10">Quantité en stock:</p>
            <div className="flex items-center border-4 px-2 py-1 text-black border-[#CFA15D]">
              {item.itemStock}
            </div>
          </div>
        </div>
